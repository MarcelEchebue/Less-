...
import emailjs from '@emailjs/browser'; // Ajoute cette ligne
...
export default function ContactSection({ onNavigate }: ContactSectionProps) {
    ...
    const [isSubmitting, setIsSubmitting] = useState(false); // État pour loader
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            await emailjs.sendForm(
                'service_yp4qki4', // Remplace par ton Service ID
                'template_7k2wm98', // Remplace par ton Template ID
                e.currentTarget,
                '2N4jmHMnFyUTkI8Ab' // Remplace par ta Public Key
            );
            toast({
