...
import didierPortrait from '@/assets/architect-portrait.jpg';
...
export function AboutSection({ onNavigate }: AboutSectionProps) {
  ...
  const highlightedText = t('about.description')
  .replace(/\n/g, '<br /><br />') // convierte saltos de línea en dobles <br> (separación de párrafo)
  .replace(/(arquitecto|fundador|UNESCO|BIM|inteligencia artificial|humanista|coherente|esencial)/gi, '<strong>$1</strong>');
