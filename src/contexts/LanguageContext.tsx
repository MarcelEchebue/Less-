...
const translations = {
  es: {
    ...
    'contact.form.name': 'Nombre: Less +',
    'contact.form.email': 'Tu correo: Infoless+@example.com',
  ...
  fr: {
    ...
    'contact.form.name': 'Nom : Didier',
    'contact.form.email': 'Votre email: Infoless+@example.com',
...
,
  en: {
    ...
    'contact.form.name': 'Name: Less +',
    'contact.form.email': 'Your email: Infoless+@example.com',
